...
const preSignUpTrigger = async (event: Event): Promise<Event> => {
...
const createAuthChallengeTrigger = async (event: Event): Promise<Event> => {
...
const verifyAuthChallengeResponseTrigger = async (event: Event): Promise<Event> => {
