...
// Pre Sign-Up Trigger
app.post('/pre-signup', async (req: Request, res: Response) => {
    try {
...
app.post('/create-auth-challenge', async (req: Request, res: Response) => {
    try {
...
app.post('/verify-auth-challenge', async (req: Request, res: Response) => {
    try {
